...
public class ConveyorObjectSouth implements IGameObject {
    private int speed;
    Sprite sprite;
    ...
    public ConveyorObjectSouth(RectangleMapObject conveyerFromTile, TileGrid grid, int speed){
        this.speed = speed;
    ...
    public void handleCollision(Player player, TileGrid grid){
        ...
        temporaryDirection = Game.Direction.South;
