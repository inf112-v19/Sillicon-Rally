...
public class PlayerTurnTest {
	...
	public void doTurnTestAndMoveTest(){ //perfectTitle
		...
		System.out.println(player1.getY() + "|| orig ||" + player1.getX() + ": Y, X");



		round.doTurn(testDeck, playerlist, grid);
		System.out.println(grid.tileSizeInPx);
		System.out.println(player1.getY() + "||||" + player1.getX() + ": Y, X");

		assertEquals((float) 3*grid.tileSizeInPx, player1.getY());
